...
plt.savefig(os.path.join(output_dir, "1_gamma_self_full_polar.png"), dpi=300, bbox_inches='tight', facecolor=polar_bg_color)
plt.close(fig1)
...
plt.savefig(os.path.join(output_dir, "2_gamma_self_zoom_polar.png"), dpi=300, bbox_inches='tight', facecolor=polar_bg_color)
plt.close(fig2)
...
plt.savefig(os.path.join(output_dir, "3_marginal_pdf_r.png"), dpi=300, bbox_inches='tight', facecolor=other_bg_color)
plt.close(fig3)
...
plt.savefig(os.path.join(output_dir, "4_xy_scatter_samples.png"), dpi=300, bbox_inches='tight', facecolor=other_bg_color)
plt.close(fig4)
...
print(output_dir)
print("\nFiles created:")
print("   1_gamma_self_full_polar.png")
print("   2_gamma_self_zoom_polar.png")
print("   3_marginal_pdf_r.png")
print("   4_xy_scatter_samples.png")
