...
- and why current AI architectures are especially vulnerable to it  
...
GRP provides the conceptual tools to make this phenomenon visible.
...
# **3. How RSL Manifests in AI Behavior**
...
# **5. Why RSL Increases With Intelligence**
...
# **7. How Future Systems Could Reduce RSL**
...
GRP makes this geometry visible.
