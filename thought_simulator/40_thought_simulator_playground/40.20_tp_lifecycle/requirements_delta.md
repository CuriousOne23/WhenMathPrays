...
- Delta: Deterministic TP identity generation under `deterministic_mode`
	- Document modified: `20_requirements/archive/20.30_tp_requirements.md`
...
- Delta: `harness.py` is the only execution entrypoint for module verification
	- Document modified: `20_requirements/archive/20.30_tp_requirements.md`; `20_requirements/archive/20.60_testing_and_validation.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: Verification artifacts include serialized TP state, provenance, and history for replay/audit
	- Document modified: `20_requirements/archive/20.30_tp_requirements.md`; `20_requirements/archive/20.50_observability_requirements.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: Verification artifacts are written into `artifacts/` instead of the module root
	- Document modified: `20_requirements/archive/20.30_tp_requirements.md`; `20_requirements/archive/20.90_interfaces_and_io.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: The module preserves all migrated history when legacy report files are removed
	- Document modified: `20_requirements/archive/20.60_testing_and_validation.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: IO schema compatibility and artifact path expectations are documented in `software_description.md`
	- Document modified: `40_thought_simulator_playground/40.20_tp_lifecycle/software_description.md`; `20_requirements/archive/20.90_interfaces_and_io.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
