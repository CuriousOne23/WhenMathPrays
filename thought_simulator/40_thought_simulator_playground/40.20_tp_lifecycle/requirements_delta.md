...
- Delta: IO schema compatibility and artifact path expectations are documented in `software_description.md`
	- Document modified: `40_thought_simulator_playground/40.20_tp_lifecycle/software_description.md`; `thought_simulator/20_requirements/20.90_ib_requirements.md` (updated May 27, 2026)
	- Version/date of modification: updated May 27, 2026
