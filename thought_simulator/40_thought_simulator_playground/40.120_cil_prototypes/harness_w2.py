"""W2 clarification_event wire harness for 40.120 CIL prototypes."""
...
for name, rel in (("upi_prototype", "40.90_upi_prototypes/prototype.py"),):
...
def main() -> int:
    ...
    report = {"module": "40.120_cil_prototypes_w2", "phase": "B", "status": status, "scenarios": scenarios}
