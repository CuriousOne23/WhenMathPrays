...
- Stay humble about what we donâ€™t know  
...
```
<module_name>/
â”œâ”€â”€ software_description.md          # Tentative design sketch
â”œâ”€â”€ prototype.py                     # Macro-style exploratory implementation
â”œâ”€â”€ harness.py                       # Test / verification runner
â”œâ”€â”€ verification_capsule.md          # Canonical verification report and migrated history
â”œâ”€â”€ requirements_delta.md            # Requirement evolution and implementer feedback
â””â”€â”€ artifacts/                       # Run artifacts, snapshots, and reproducibility evidence
```
...
1. **Reference only existing requirement documents.**
  The moduleâ€™s `software_description.md` must list only the requirement files that actually exist in the repository.
...
These rules apply only to exploratory modules with missing requirement coverage. Established subsystems continue to follow the standard requirements â†’ design â†’ implementation â†’ verification pipeline.
...
### Execution Report â€” [Module Name]
...
|------|--------|---------|------------------|--------|-----------|-----------|---------|---------|---------|-------------|---------------------|------------------------|-------|
| YYYY-MM-DD | ... | ... | ... | ... | ... | ... | HLR-2 | LLR-2.3 | software_description.md | Â§3.4.1 | ... | ... | ... |
...
# Test â†’ Requirement Attachment Rules
...
â†’ **Low-Level Requirement (LLR)**  
â†’ **Test Case**  
â†’ **Evidence / Artifacts**  
â†’ **Verification Capsule**
...
1. **Design** â€” Write/update `software_description.md`  
2. **Prototype** â€” Implement in `prototype.py` (macro-style)  
3. **Test & Verify** â€” Run `harness.py` and collect evidence  
4. **Attach Requirements** â€” Update run records with HLR/LLR references and IO fields exercised  
5. **Record** â€” Update `verification_capsule.md` and `requirements_delta.md`  
6. **Refine** â€” Update requirements, glossary usage, and traceability if needed  
7. **Stabilize** â€” When coherent and verified, promote to `50_thought_simulator_design/`  
