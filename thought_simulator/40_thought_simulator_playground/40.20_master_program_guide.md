...
At the playground root, `40.30_verification_glossary.md` defines the canonical vocabulary shared by all modules.
...
| `40.30_verification_glossary.md` | Canonical shared vocabulary for scenario, artifact, deterministic_mode, provenance, and verification terms |
