# 40.50_inb_prototypes / software_description.md
...
- Note: The full HLR list from 20.100_inb_requirements.md is included in this document for exploratory clarity and to make the complete requirement space visible during playground exploration. 20.xx remains the sole source of truth; 30.xx remains the authoritative coverage audit layer. 40.50 is a playground and not authoritative.
...
- 40.05_master_program_guide.md (workflow guidance for playground exploration — not treated as requirements)
- 40.50_inb_prototypes/prototype.py (implemented skeleton)
- 40.50_inb_prototypes/harness.py (16-scenario harness)
- 40.50_inb_prototypes/verification_capsule.md (Part B evidence summary)
- 40.50_inb_prototypes/requirements_delta.md (executed delta + open work)
- 40.50_inb_prototypes/artifacts/inb_verification_run_2026-06-08.json
