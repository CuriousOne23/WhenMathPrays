...
**Version:** 0.7  
**Date:** 2026-06-08  
**Status:** **Active** — Phase 0 complete (rows 000–001); 40.510-103 `approved`; **GATE-A** (101–102) pending ☑ per §7.1.
...
| 40.510-101 | **`40.101_iiinb_prototypes/`** *(new)* | Create — `profile_enabled` gate; `input_semantic_repair`; read-only USP; intake-bound TP writes only | B2 | 1 | done | ☐ | ☐ | ☐ | 20.101, 20.38 §6 | **GATE-A** — 6/6 PASS `iiinb_verification_run_2026-06-08.json` |
| 40.510-102 | **`40.207_replay_prototypes/`** *(new)* | Create — runnable REPLAY_CLASS_7 C7-A..E; classes 1–6; strip/diff artifacts | B5 | 1 | done | ☐ | ☐ | ☐ | 20.36 §9, 20.207 | **GATE-A** — C7 5/5 PASS `replay_class7_verification_run_2026-06-08.json` |
| 40.510-103 | `40.100_inb_prototypes/` | Targeted redo — handoff `InB → IIInB` (not direct RB); tick-boundary tests | B2 | 1 | approved | ☑ | ☑ | ☑ | 20.100 | Phase B approved 2026-06-08 — 16/16 PASS; CP Phase B review; full test matrix |
