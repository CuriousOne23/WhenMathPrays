...
| 40.510-201 | **`40.102_usp_prototypes/`** *(new)* | Create — versioned shorthand rule store; read-only to IIInB | B3 | 2 | W2 | approved | ☑ | ☐ | ☐ | 20.102 | **GATE-B closed 2026-06-08** — Phase B 8/8 PASS `usp_verification_run_2026-06-08.json` |
