...
| **2 — 30 normalize** | Promote wave evidence per [30.00](../30_verification/30.00_verification_user_guide.md) | Wave coverage note: HLR mapping, glossary alignment ([30.160](../30_verification/30.160_verification_glossary.md)), open gaps | Reviewers |
...
| 40.510-101 | **`40.60_iiinb_prototypes/`** *(new)* | Create — `profile_enabled` gate; `input_semantic_repair`; read-only USP; intake-bound TP writes only | B2 | 1 | W1 | approved | ☑ | ☑ | ☑ | 20.101, 20.38 §6 | **GATE-A + [50.230](../50_thought_simulator_design/50.230_iiinb_design_spec.md) CP W1+W2 insight** — 24/24 W2 total |
...
| 40.510-203 | **`40.100_core_data_structs_prototypes/`** *(new)* | Create — `UspSnapshot`, `InputRepairTag`, `ConversationLayerState`; envelope separation | B8 | 2 | W2 | approved | ☑ | ☑ | ☑ | 20.39 §3.1–3.2 | **50.42 CP design-clean 2026-06-08** — 10.50.42 + 30.140 + [50.42](../50_thought_simulator_design/50.42_core_data_structs_design_spec.md); 8/8 PASS |
...
- Verification vocabulary → [30.160_verification_glossary.md](../30_verification/30.160_verification_glossary.md)
