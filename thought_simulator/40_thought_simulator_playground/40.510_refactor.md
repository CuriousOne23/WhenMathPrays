...
| 40.510-203 | **`40.392_core_data_structs_prototypes/`** *(new)* | Create — `UspSnapshot`, `InputRepairTag`, `ConversationLayerState`; envelope separation | B8 | 2 | W2 | approved | ☑ | ☐ | ☐ | 20.39 §3.1–3.2 | Phase B 8/8 PASS 2026-06-08 `structs_verification_run_2026-06-08.json` |
