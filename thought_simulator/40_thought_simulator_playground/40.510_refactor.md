...
| 40.510-103 | `40.100_inb_prototypes/` | Targeted redo — handoff `InB → IIInB` (not direct RB); tick-boundary tests | B2 | 1 | done | ☐ | ☐ | ☐ | 20.100 | 8/8 PASS; `handoff` contract + `positive_iiinb_handoff_contract` |
