...
| 40.510-102 | **`40.207_replay_prototypes/`** *(new)* | Create — runnable REPLAY_CLASS_7 C7-A..E; classes 1–6; strip/diff artifacts | B5 | 1 | W1 | done | ☐ | ☐ | ☐ | 20.36 §9, 20.207 | **GATE-A** — Phase B approved (CP, 2026-06-08); 18/18 PASS `replay_class7_verification_run_2026-06-08.json`; full test matrix; reviewer ☑ pending; W5 feeder via 505–506 |
