...
| W2 | Phase A drafts (201–207) | pending | pending | — | **Phase A started 2026-06-08** — `software_description.md` for 102, 103, 392 (new) + 32, 33, 36, 101 (W2 extensions); GATE-B on 201–202 after Phase A approval |
...
| 40.510-201 | **`40.102_usp_prototypes/`** *(new)* | Create — versioned shorthand rule store; read-only to IIInB | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.102 | **GATE-B** — Phase A draft 2026-06-08 |
