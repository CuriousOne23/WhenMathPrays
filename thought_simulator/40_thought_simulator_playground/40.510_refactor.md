...
| 40.510-101 | **`40.101_iiinb_prototypes/`** *(new)* | Create — `profile_enabled` gate; `input_semantic_repair`; read-only USP; intake-bound TP writes only | B2 | 1 | W1 | done | ☐ | ☐ | ☐ | 20.101, 20.38 §6 | **GATE-A** — Phase A complete; initial 6/6 PASS `iiinb_verification_run_2026-06-08.json`; Phase B approval pending |
