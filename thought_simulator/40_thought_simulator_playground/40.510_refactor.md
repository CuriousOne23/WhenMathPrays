...
**Version:** 0.8.5
**Date:** 2026-06-08  
**Status:** **Active** — **W1 exit complete** 2026-06-08; **W2 Phase A in progress** (rows 201–207 `software_description.md` drafts); Waves 3–5 pending per §4.2. Program doc **approved** v0.8.5.
...
| W2 | Phase A: 201–206 approved; 207 draft | pending | pending | — | **Phase A in progress 2026-06-08** — GATE-B rows 201–202 + 203 + 204–206 CP-approved; 101 extension pending review; GATE-B close after 201–202 Phase B |
...
| 40.510-207 | `40.101_iiinb_prototypes/` | Envelope write-guard negative tests — no `semantic_core` / `TP.TR` writes | B2/B8 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.38 §2, §8 | W2 Phase A extension 2026-06-08; 024b / `FAIL_ENVELOPE` |
