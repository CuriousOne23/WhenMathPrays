...
**Version:** 0.6  
**Date:** 2026-06-08  
**Status:** **Active** — Phase 0 complete (rows 000–001); Phase 1 evidence complete (101–103 `done`); **GATE-A** pending ☑ per §7.1.
...
| 40.510-103 | `40.100_inb_prototypes/` | Targeted redo — handoff `InB → IIInB` (not direct RB); tick-boundary tests | B2 | 1 | done | ☐ | ☐ | ☐ | 20.100 | Phase B 16/16 PASS; full test matrix; tick-boundary + schema + zero-event |
