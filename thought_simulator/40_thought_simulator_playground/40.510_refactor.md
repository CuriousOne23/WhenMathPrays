...
| `40.440_regulator_prototypes/` | 20.50 RB | New RB module → `40.460_rb_prototypes/` |
| `40.480_tick_cycle_skeleton/` | 20.60 TB | New TB module → `40.500_tb_prototypes/` |
| `40.490_mb_prototypes/` | 20.39 core structs | New struct module → `40.392_core_data_structs_prototypes/` |
...
| 40.510-101 | **`40.101_iiinb_prototypes/`** *(new)* | Create — `profile_enabled` gate; `input_semantic_repair`; read-only USP; intake-bound TP writes only | B2 | 1 | W1 | approved | ☑ | ☑ | ☑ | 20.101, 20.38 §6 | **GATE-A + [50.101](../50_thought_simulator_design/50.101_iiinb_design_spec.md) CP W1+W2 insight** — 24/24 W2 total |
| 40.510-102 | **`40.207_replay_prototypes/`** *(new)* | Create — runnable REPLAY_CLASS_7 C7-A..E; classes 1–6; strip/diff artifacts | B5 | 1 | W1 | approved | ☑ | ☑ | ☑ | 20.36 §9, 20.207 | **GATE-A closed 2026-06-08** — Phase B approved (CP); 18/18 PASS `replay_class7_verification_run_2026-06-08.json`; W5 feeder via 505–506 |
...
| 40.510-201 | **`40.102_usp_prototypes/`** *(new)* | Create — versioned shorthand rule store; read-only to IIInB | B3 | 2 | W2 | approved | ☑ | ☑ | ☑ | 20.102 | **50.102 CP design-clean 2026-06-08** — 10.50.102 + 30.102 + [50.102](../50_thought_simulator_design/50.102_usp_design_spec.md); GATE-B; 8/8 PASS |
| 40.510-202 | **`40.103_upi_prototypes/`** *(new)* | Create — `clarification_event` → GB gate → USP commit | B3 | 2 | W2 | approved | ☑ | ☑ | ☑ | 20.103, 20.80 §10 | **50.103 CP design-clean 2026-06-08** — 10.50.103 + 30.103 + [50.103](../50_thought_simulator_design/50.103_upi_design_spec.md); GATE-B; 8/8 PASS |
| 40.510-203 | **`40.392_core_data_structs_prototypes/`** *(new)* | Create — `UspSnapshot`, `InputRepairTag`, `ConversationLayerState`; envelope separation | B8 | 2 | W2 | approved | ☑ | ☑ | ☑ | 20.39 §3.1–3.2 | **50.392 CP design-clean 2026-06-08** — 10.50.392 + 30.392 + [50.392](../50_thought_simulator_design/50.392_core_data_structs_design_spec.md); 8/8 PASS |
| 40.510-204 | `40.32_cob_prototypes/` | Targeted redo — USP snapshot version pins | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.32 | W2 Phase B 4/4 PASS `cob_w2_verification_run_2026-06-08.json`; base 2026-06-03 |
| 40.510-205 | `40.33_cil_prototypes/` | Targeted redo — `clarification_event` wire to UPI | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.33 | W2 Phase B 4/4 PASS `cil_w2_verification_run_2026-06-08.json`; base 2026-06-03 |
| 40.510-206 | `40.36_gb_prototypes/` | Targeted redo — UPI commit governance; GB veto path | B6 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.80 §10, 20.16 | W2 Phase B 4/4 PASS `gb_w2_verification_run_2026-06-08.json` |
| 40.510-207 | `40.101_iiinb_prototypes/` | Envelope write-guard negative tests — no `semantic_core` / `TP.TR` writes | B2/B8 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.38 §2, §8 | W2 extension 5/5 PASS in `iiinb_verification_run_2026-06-08_w2.json` (24/24 total) |
...
| 40.510-401 | **`40.115_mtp_prototypes/`** *(new)* | Create — MTP lifecycle; `commit_id`; snapshot refs | B1 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.115, 20.120 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (`commit_id` anchor; joint 130/140); W4/W5 hard dep |
| 40.510-402 | `40.20_tp_lifecycle/` | Targeted redo — intake repair fields; `commit_id` boundary | B1 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.105 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (20.105 §3.4 + 20.101 handoff); schema v1 retained |
| 40.510-403 | **`40.130_split_merge_prototypes/`** *(new)* | Create — split/merge; `lineage_delta`; ΔH% accounting | B1 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.130 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 402/501/115) |
| 40.510-404 | **`40.140_truth_done_prototypes/`** *(new)* | Create — truth/done terminal evaluation | B1 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.140 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 601/130/115) |
| 40.510-405 | **`40.460_rb_prototypes/`** *(new)* | Create — RB routing; `InB → IIInB → RB` handoff | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.50 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 100/101/37/130) |
| 40.510-406 | **`40.401_ob_prototypes/`** *(new)* | Create — OB lane-local evidence extraction | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.40 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 501/37/106/601) |
| 40.510-407 | **`40.106_dcb_prototypes/`** *(new)* | Create — DCB trajectory observation | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.106 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 401/37/165) |
| 40.510-408 | `40.165_dcb_stability_prototypes/` | Implement — qualitative stability per 20.165 | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.165, 20.106 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (qualitative observer; joint 40.106) |
| 40.510-409 | **`40.500_tb_prototypes/`** *(new)* | Create — TB interpretation (pre–Truth/Done) | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.60 | **W3 Phase A approved 2026-06-08** — scaffold created; Phase B pending |
| 40.510-410 | `40.37_tr_router_prototypes/` | Extend — DCB ephemeral TR events; `tr_needs_update` gating | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.37, 20.106 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (on-TP 20.37; joint 40.106/40.401); proxy regression retained |
| 40.510-411 | `40.35_ib_prototypes/` | Extend — IIInB vs IB vs IMR escalation routing | B2/B6 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.90, 20.17 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (IIInB/IB/IMR seam; joint 40.101) |
| 40.510-412 | `40.30_basin_prototypes/` | Full redo — decompose or realign to normative A basins | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.01 B2 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (20.01 B2 decomposition; joint 405–411) |
...
| 40.510-503 | `40.480_tick_cycle_skeleton/` | Full redo — replace generic phases with normative A→B orchestration | B5 glue | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.36 §2.1 | Inner tick mechanics must reflect 20.36 §2.1 order |
| 40.510-504 | `40.520_snapshot_prototypes/` | Full redo — `commit_id` / `semantic_core` freeze snapshots | B5 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.206 | Snapshots scoped to commit boundary, not generic state |
| 40.510-505 | `40.530_event_log_prototypes/` | Full redo — replay classes 1–7; strip-replay invariant | B5 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.36, 20.207 | Event log must support falsifiable replay classes |
| 40.510-506 | `40.540_experiment_runner/` | Targeted redo — unified replay orchestration host | B5 glue | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.36 | Batch runner hosts Class 1–7 suites; may subsume 40.207 |
| 40.510-507 | `40.440_regulator_prototypes/` | Targeted redo — ΔH% stage placement in A pipeline | B2/B7 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.130, 20.150 | ΔH% belongs post-merge in A chain, not ad hoc |
...
| 40.510-603 | `40.490_mb_prototypes/` | Light extend — fixture-grade basin audit traces | B6 | — | — | todo | ☐ | ☐ | ☐ | 20.70, 20.36 | |
...
| 0.8.13 | 2026-06-08 | CP | **50.392 CP design-clean** — W2 GATE-B struct-anchor sign-off; 20.039/10.50.392/30.392/40.392 aligned; cross-module 102/103/101 consistent |
...
| 0.8.15 | 2026-06-08 | CP | **50.102 CP design-clean** — W2 GATE-B USP anchor; 20.102/10.50.102/30.102/40.102 aligned; UPI-only write + IIInB read-only; COB pin 30.32 cross-evidence |
...
| 0.8.17 | 2026-06-08 | CP | **50.103 CP design-clean** — W2 GATE-B UPI anchor; 20.103/10.50.103/30.103/40.103 aligned; **GATE-B 50-layer complete (392+102+103)** |
...
| 0.8.20 | 2026-06-08 | CP | **40.510-402 W3 Phase A CP review recorded** — `40.20_tp_lifecycle` targeted redo: no blockers; Phase B cleared; `tp_lifecycle_io_schema_v1` retained |
| 0.8.21 | 2026-06-08 | CP | **40.510-408 W3 Phase A CP review recorded** — `40.165_dcb_stability_prototypes`: no blockers; Phase B cleared; qualitative-only; joint 40.106 |
| 0.8.22 | 2026-06-08 | CP | **40.510-410 W3 Phase A CP review recorded** — `40.37_tr_router_prototypes`: no blockers; Phase B cleared; `tr_needs_update` + DCB ephemeral TR; proxy regression retained |
| 0.8.23 | 2026-06-08 | CP | **40.510-411 W3 Phase A CP review recorded** — `40.35_ib_prototypes`: no blockers; Phase B cleared; IIInB/IB/IMR escalation seam; joint 40.101 |
| 0.8.24 | 2026-06-08 | CP | **40.510-412 W3 Phase A CP review recorded** — `40.30_basin_prototypes`: no blockers; Phase B cleared; 20.01 B2 A-basin decomposition; joint 405–411 |
| 0.8.25 | 2026-06-08 | CP | **40.510-401 W3 Phase A CP review recorded** — `40.115_mtp_prototypes`: no blockers; Phase B cleared; `commit_id`/`mtp_update` A-chain anchor; W4/W5 hard dep |
| 0.8.26 | 2026-06-08 | CP | **40.510-403 W3 Phase A CP review recorded** — `40.130_split_merge_prototypes`: no blockers; Phase B cleared; `lineage_delta`/ΔH%; joint 402/501/115 |
| 0.8.27 | 2026-06-08 | CP | **40.510-404 W3 Phase A CP review recorded** — `40.140_truth_done_prototypes`: no blockers; Phase B cleared; truth/done gate; joint 601/130/115 |
| 0.8.28 | 2026-06-08 | CP | **40.510-405 W3 Phase A CP review recorded** — `40.460_rb_prototypes`: no blockers; Phase B cleared; `InB→IIInB→RB`; joint 100/101/37/130 |
| 0.8.29 | 2026-06-08 | CP | **40.510-406 W3 Phase A CP review recorded** — `40.401_ob_prototypes`: no blockers; Phase B cleared; lane-local OB; joint 501/37/106/601 |
| 0.8.30 | 2026-06-08 | CP | **40.510-407 W3 Phase A CP review recorded** — `40.106_dcb_prototypes`: no blockers; Phase B cleared; geometric meta-basin; joint 401/37/165 |
