...
| 40.510-405 | **`40.501_rb_prototypes/`** *(new)* | Create — RB routing; `InB → IIInB → RB` handoff | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.50 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 100/101/37/130) |
...
| 40.510-409 | **`40.601_tb_prototypes/`** *(new)* | Create — TB interpretation (pre–Truth/Done) | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.60 | **W3 Phase A approved 2026-06-08** — scaffold created; Phase B pending |
...
| 0.8.28 | 2026-06-08 | CP | **40.510-405 W3 Phase A CP review recorded** — `40.501_rb_prototypes`: no blockers; Phase B cleared; `InB→IIInB→RB`; joint 100/101/37/130 |
