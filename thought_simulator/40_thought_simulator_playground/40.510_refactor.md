...
| 40.510-401 | **`40.115_mtp_prototypes/`** *(new)* | Create — MTP lifecycle; `commit_id`; snapshot refs | B1 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.115, 20.120 | **W3 Phase A approved 2026-06-08** — scaffold + `software_description.md`; Phase B pending |
