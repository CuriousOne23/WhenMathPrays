...
**Version:** 0.8  
**Date:** 2026-06-08  
**Status:** **Active** — **Wave 1** in progress (103 `approved`; GATE-A 101–102 pending ☑); Waves 2–5 pending per §4.2.
...
|------|-------------------|---------------|-----------------|----------|------------------------|
| W1 | *in progress* (103 approved; 101–102 `done`) | pending | pending | — | GATE-A pending ☑; target: close W1 before W2 40 work |
...
| 40.510-102 | **`40.207_replay_prototypes/`** *(new)* | Create — runnable REPLAY_CLASS_7 C7-A..E; classes 1–6; strip/diff artifacts | B5 | 1 | W1 | done | ☐ | ☐ | ☐ | 20.36 §9, 20.207 | **GATE-A** — C7 5/5 PASS `replay_class7_verification_run_2026-06-08.json` |
