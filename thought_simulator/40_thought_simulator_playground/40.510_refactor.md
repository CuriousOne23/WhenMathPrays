...
**Owner guide:** Scheduling and capsule standards remain under [40.05_master_program_guide.md](40.05_master_program_guide.md). 40.510 does not replace 40.160; it is the **refactor program inventory** for the Track H / dual-pipeline alignment pass.
...
| `40.270_scheduler_prototypes/` | 20.40 OB | New OB module → `40.1600_ob_prototypes/` |
| `40.1100_regulator_prototypes/` | 20.50 RB | New RB module → `40.190_rb_prototypes/` |
| `40.280_tick_cycle_skeleton/` | 20.60 TB | New TB module → `40.230_tb_prototypes/` |
| `40.2500_mb_prototypes/` | 20.39 core structs | New struct module → `40.100_core_data_structs_prototypes/` |
...
| **5** | Orchestration + replay glue | Phases 1–4 underway | Scheduler/tick/snapshot/event-log/experiment-runner redos + 40.1606 sync `approved` |
...
- [ ] `40.60_*` folder scaffolded per 40.160 capsule structure
...
| **W3** | Pipeline A primitives | 401–412 | `40.150`, `40.160_tp`, split/merge, truth/done, `40.501`, `40.1600`, DCB, TB, TR, IB, basin | W1 exit (GATE-A) | A-chain collective review |
| **W4** | Pipeline B cluster | 301–308 | `40.180`, `40.55`, `40.57`, `40.41`–`43`, `40.205`, `40.45` | W2 GATE-B; 401 ≥ `wip` | **GATE-C** |
| **W5** | Orchestration + replay glue | 501–507 | `40.1606`, scheduler, tick, snapshot, event-log, experiment-runner, regulator | W3–W4 underway; 501 `done` min | **GATE-D**, **GATE-E** |
...
| 40.510-001 | `40.05_master_program_guide.md` | Cross-link 40.510 as refactor owner | Meta | 0 | — | approved | ☑ | ☑ | ☑ | 40.160, 20.510 | v0.12 approved 2026-06-08; paired with 40.510 program sign-off |
...
| 40.510-301 | `40.180_oub_prototypes/` | Implement — read-only `semantic_core`; output realization | B4 | 3 | W4 | todo | ☐ | ☐ | ☐ | 20.110, 20.58 | B-side output manifold; meaning frozen before expression |
...
| 40.510-406 | **`40.1600_ob_prototypes/`** *(new)* | Create — OB lane-local evidence extraction | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.40 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (joint 501/37/106/601) |
...
| 40.510-410 | `40.240_tr_router_prototypes/` | Extend — DCB ephemeral TR events; `tr_needs_update` gating | B2 | 4 | W3 | wip | ☐ | ☑ | ☑ | 20.37, 20.106 | **W3 Phase A CP-approved 2026-06-08** — no blockers; Phase B cleared (on-TP 20.37; joint 40.210/40.1600); proxy regression retained |
...
| 40.510-501 | **`40.1606_ab_sync_prototypes/`** *(new)* | Create — `mtp_update` freeze → `commit_id` → Pipeline B handoff | B5 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.206 | **GATE-D** — proves A freeze before B; blocks orchestration glue |
...
| 40.510-505 | `40.2600_event_log_prototypes/` | Full redo — replay classes 1–7; strip-replay invariant | B5 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.36, 20.207 | Event log must support falsifiable replay classes |
...
| 40.510-507 | `40.1100_regulator_prototypes/` | Targeted redo — ΔH% stage placement in A pipeline | B2/B7 | 5 | W5 | todo | ☐ | ☐ | ☐ | 20.130, 20.150 | ΔH% belongs post-merge in A chain, not ad hoc |
| **Keep / light touch (outside waves)** |
| 40.510-601 | `40.1200_math_prototypes/` | Keep — optional 20.95 alignment when promoted | B7 | — | — | todo | ☐ | ☐ | ☐ | 20.35, 20.95 | README exception policy |
| 40.510-602 | `40.3400_cop_prototypes/` | Keep — verify propose-only boundary | B3 | — | — | todo | ☐ | ☐ | ☐ | 20.34 | |
| 40.510-603 | `40.2500_mb_prototypes/` | Light extend — fixture-grade basin audit traces | B6 | — | — | todo | ☐ | ☐ | ☐ | 20.70, 20.36 | |
...
| Action | Meaning |
|--------|---------|
| **Create** | New `40.xx_*` folder with full capsule structure per 40.160 |
...
4. Flows Alignment Statement in `software_description.md` (per 40.160)
...
| A meaning freeze | 40.150, 40.1600, 40.170, 40.180, 40.501 | `mtp_update` before any B module runs |
...
- Playground onboarding subset → [40.160 Appendix B](40.05_master_program_guide.md#appendix-b--playground-glossary-onboarding)
...
| 0.8.29 | 2026-06-08 | CP | **40.510-406 W3 Phase A CP review recorded** — `40.1600_ob_prototypes`: no blockers; Phase B cleared; lane-local OB; joint 501/37/106/601 |
