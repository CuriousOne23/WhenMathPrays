...
| 40.510-202 | **`40.103_upi_prototypes/`** *(new)* | Create — `clarification_event` → GB gate → USP commit | B3 | 2 | W2 | approved | ☑ | ☐ | ☐ | 20.103, 20.80 §10 | **GATE-B closed 2026-06-08** — **Phase B approved** (CP; 8/8 PASS) `upi_verification_run_2026-06-08.json` |
