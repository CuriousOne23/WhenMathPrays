...
|------|-------------------|---------------|-----------------|----------|------------------------|
| W1 | 103 `approved`; 101–102 `done` (GATE-A ☑ pending) | pending | pending | — | Next: close GATE-A on 101–102 → 30 normalize → 50 insight → `continue` before W2 |
...
| 40.510-101 | **`40.101_iiinb_prototypes/`** *(new)* | Create — `profile_enabled` gate; `input_semantic_repair`; read-only USP; intake-bound TP writes only | B2 | 1 | W1 | done | ☐ | ☐ | ☐ | 20.101, 20.38 §6 | **GATE-A** — Phase A approved (CP, 2026-06-08); Phase B v0.1 6/6 PASS `iiinb_verification_run_2026-06-08.json`; formal approval pending |
