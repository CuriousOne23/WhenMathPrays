...
**Version:** 0.8.6
**Date:** 2026-06-08  
**Status:** **Active** — **W1 exit complete** 2026-06-08; **W2 Phase A complete** 2026-06-08 (rows 201–207 CP-approved); Waves 3–5 pending per §4.2. Program doc **approved** v0.8.6.
...
| W2 | Phase A complete (201–207); Phase B open | pending | pending | — | **Phase A complete 2026-06-08** — rows 201–207 CP-approved; GATE-B close after 201–202 Phase B + integration bundle evidence |
...
| 40.510-201 | **`40.102_usp_prototypes/`** *(new)* | Create — versioned shorthand rule store; read-only to IIInB | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.102 | **GATE-B** — **Phase A approved 2026-06-08** (CP); Phase B open |
| 40.510-202 | **`40.103_upi_prototypes/`** *(new)* | Create — `clarification_event` → GB gate → USP commit | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.103, 20.80 §10 | **GATE-B** — **Phase A approved 2026-06-08** (CP); Phase B open; prereq 201 |
| 40.510-203 | **`40.392_core_data_structs_prototypes/`** *(new)* | Create — `UspSnapshot`, `InputRepairTag`, `ConversationLayerState`; envelope separation | B8 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.39 §3.1–3.2 | **Phase A approved 2026-06-08** (CP); Phase B open |
| 40.510-204 | `40.32_cob_prototypes/` | Targeted redo — USP snapshot version pins | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.32 | **Phase A approved 2026-06-08** (CP; base + W2 extension); Phase B base 2026-06-03; W2 pin harness open |
| 40.510-205 | `40.33_cil_prototypes/` | Targeted redo — `clarification_event` wire to UPI | B3 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.33 | **Phase A approved 2026-06-08** (CP; base + W2 extension); Phase B base 2026-06-03; W2 wire harness open |
| 40.510-206 | `40.36_gb_prototypes/` | Targeted redo — UPI commit governance; GB veto path | B6 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.80 §10, 20.16 | **Phase A approved 2026-06-08** (CP; base + W2 extension); Phase B open |
| 40.510-207 | `40.101_iiinb_prototypes/` | Envelope write-guard negative tests — no `semantic_core` / `TP.TR` writes | B2/B8 | 2 | W2 | wip | ☐ | ☐ | ☐ | 20.38 §2, §8 | **Phase A approved 2026-06-08** (CP; W2 extension); W1 Phase B 19/19 PASS; 024b harness open |
