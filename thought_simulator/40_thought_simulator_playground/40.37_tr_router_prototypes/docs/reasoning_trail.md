...
## Purpose
This document captures the step-by-step reasoning, design decisions, and three-flow alignment for the 40.37 TR router prototype exploration.
...
- Future 50.37 design will likely drive deeper 40.37 work on full TR semantics.
