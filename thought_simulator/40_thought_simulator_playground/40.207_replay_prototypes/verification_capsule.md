...
- Evidence types (40.20): behavioral, structural (fixture IDs, intake path, B envelope guards), negative (regen input / forbidden lane_id), replay, golden diff (strip + diagnostic export digests)
- Core invariants demonstrated:
  - REPLAY_CLASS_7 C7-A..E (live 40.100/40.101 + simulated UPI/GB for C7-D/E)
...
- **Forward Flow (20-series)**: [20.36](../../20_requirements/20.36_canonical_end_to_end_trace.md) §9 Class 7; [20.207](../../20_requirements/20.207_execution_replay_specification.md) E1 strip + regen input scaffold; upstream [40.100](../40.100_inb_prototypes/software_description.md), [40.101](../40.101_iiinb_prototypes/software_description.md).
