...
- upstream_playground_modules: 40.100_inb_prototypes, 40.101_iiinb_prototypes (live intake path for C7 runners)
...
It provides runnable golden-minimum fixtures **C7-A..E** that exercise the intake path through [40.100](../40.100_inb_prototypes/software_description.md) InB and [40.101](../40.101_iiinb_prototypes/software_description.md) IIInB, asserting replay equivalence, envelope isolation, and cross-turn USP visibility policies from [20.101](../../20_requirements/20.101_iiinb_requirements.md).
...
- Composing InB → IIInB intake paths via upstream 40.100/40.101 prototypes
- Emitting `replay_class`, `fixture_id`, `sub_id`, per-assertion pass/fail, and artifact JSON per 40.20 evidence standards
...
- Own InB or IIInB repair semantics (40.100, 40.101)
...
- Cross-links to upstream 40.100/40.101 intake evidence
...
**May hold (per run):**
- Dynamically loaded 40.100 / 40.101 prototype modules (importlib)
...
- **C7-D/E simulation fidelity:** Cross-turn and veto paths use snapshot simulation, not live 40.103/40.36 prototypes — Wave 2 integration required for production-grade replay
...
- 40.100_inb_prototypes, 40.101_iiinb_prototypes (upstream intake evidence)
- 40.20_master_program_guide.md (workflow — not requirements)
- 40.510_refactor.md (W1 row 40.510-102; W5 rows 505–506)
- 40.207_replay_prototypes/prototype.py, harness.py
- 40.207_replay_prototypes/artifacts/replay_class7_verification_run_2026-06-08.json
