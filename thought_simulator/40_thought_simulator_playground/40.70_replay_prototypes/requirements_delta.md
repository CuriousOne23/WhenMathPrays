...
- upstream: 40.50_inb_prototypes, 40.60_iiinb_prototypes

## Exploratory Note
The full 20.207 HLR set (001–030) and 20.36 Class 7 HLRs (058–064) are visible in `software_description.md`. 20.xx is authoritative; 30.xx is the coverage audit layer. 40.70 is non-canonical.
...
† C7-D/E use **simulated** UPI/GB commit outcomes (snapshot injection), not live 40.90/40.130 wire — Wave 2.
...
- **Forward Flow (20-series)**: [20.36](../../20_requirements/20.36_canonical_end_to_end_trace.md) §9 and [20.207](../../20_requirements/20.207_execution_replay_specification.md) drive replay obligations; [40.50](../40.50_inb_prototypes/software_description.md) / [40.60](../40.60_iiinb_prototypes/software_description.md) supply intake path.
...
- Live UPI/GB for C7-D/E (40.90, 40.130)
