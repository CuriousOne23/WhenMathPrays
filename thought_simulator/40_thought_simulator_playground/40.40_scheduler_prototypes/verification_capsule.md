...
- Next required milestone (per software_description): 30.00 promotion to 30.40 (if requested); use Phase B evidence to inform 10.50.40 or 50-series scheduler spec. Open policy/tie-break decisions remain with 50/10.50.
