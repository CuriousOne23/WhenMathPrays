...
- Evidence types (40.20): behavioral, structural (intake ordering, basin-chain exclusion), negative (escalate, caps, rejected handoff, USP load failure), replay, golden diff (diagnostic export)
