...
- `LLR-30.160-001`: The harness shall emit a JSON artifact containing scenario results, traceability fields, and a run summary.
  - Evidence: `basin_verification_run_2026-05-27.json`
...
- Requirement deltas are now promoted into the canonical basin requirement anchor in `10_thought_simulator_req/50_design/10.50.160_basin_requirements.md`.
