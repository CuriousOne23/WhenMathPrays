...
|----------|--------|----------|
| `InB → IIInB` handoff (`next_stage: input_semantic_repair`) | OK | 30.220 `positive_iiinb_handoff_contract`; 30.230 `positive_inb_iiinb_rb_order` |
| Intake path ordering (not in RB→OB→TR→TB chain) | OK | 30.230 `positive_not_in_rb_ob_chain`; 30.240 `positive_c7_b_intake_path_order` |
| Class 7 C7-A..E fixture shape | OK | 30.240 C7 suite + `positive_class7_fixture_ids` |
...
| HLR-013, 023, 025, 024b (IIInB) | W2 / 30.240 | MI fixtures, IMR isolation, `FAIL_ENVELOPE` negatives |
| Classes 2–6 replay, live E2 | W5 | 40.90 / 40.80 rows |
| Live UPI/GB for C7-D/E | W2 | Simulated in 30.240; 40.90/40.130 wire pending |
