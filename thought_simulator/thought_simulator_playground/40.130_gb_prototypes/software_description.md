# 40.130_gb_prototypes / software_description.md
...
Extend GB prototype to evaluate UPI rule commits per [20.80](../../20_requirements/20.80_gb_requirements.md) §10 and [20.103](../../20_requirements/20.103_upi_requirements.md) HLR-20.103-009–011: approve → ACTIVE rule; veto → `GB_VETOED` with audit only (HLR-20.102-014). Replaces simulated UPI/GB outcomes in [40.70](../40.70_replay_prototypes/software_description.md) C7-D/E for W2 integration.
...
- [40.80_usp_prototypes](../40.80_usp_prototypes/software_description.md)
...
- **Iterative Design Flow:** [50.43](../../50_thought_simulator_design/50.130_gb_design_spec.md) supervisory boundaries
