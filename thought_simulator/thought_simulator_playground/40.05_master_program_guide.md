...
2. **30-series** — When runs stabilize, evidence is normalized per [30.00](../30_verification/30.00_verification_user_guide.md) promotion standards (coverage audit; shared terms from [30.160](../30_verification/30.30_verification_glossary.md)).
...
- **Backward Flow (40-series evidence)**: Harness 7/7 PASS (`40.50_inb_prototypes/artifacts/inb_verification_run_2026-06-07.json`) — behavioral + negative + replay for HLR-20.100-002–020; no MTP mutation demonstrated.
