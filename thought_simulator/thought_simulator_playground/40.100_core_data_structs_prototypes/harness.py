"""Verification harness for 40.100 core data struct prototypes (W2 Phase B)."""
...
def scenario_iiinb_digest_compat() -> dict:
    sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "40.60_iiinb_prototypes"))
...
def main() -> int:
    ...
    report = {
        "module": "40.100_core_data_structs_prototypes",
