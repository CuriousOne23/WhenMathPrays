...
REQ = {
    ...
    "entropy_bounds": {
        "hlr": "HLR-REQ-14",
        "llr": "LLR-T-CON-02",
        "doc": "thought_simulator_req/20_requirements/20.60_testing_and_validation.md",
        "section": "§8",
    },
...
def _write_verification_capsule(results: list[ScenarioResult], tp: ThoughtPoint, merged: ThoughtPoint, children: list[ThoughtPoint]) -> None:
    ...
    lines = [
        ...
        "|---|---|---|---|---|---|---|---|---|---|---|---|",
        f"| {timestamp} | {MODULE_NAME} | python harness.py | deterministic_mode=True; scenario_set=positive+negative | PASS | 0 | artifacts/tp_state.json; artifacts/determinism_run2.json; artifacts/determinism_run3.json | HLR-ARCH-07, HLR-ARCH-08, HLR-REQ-14 | LLR-T-OBS-01, LLR-T-LVL-02, LLR-T-DET-01, LLR-T-DET-04, LLR-SEC-14-12 | thought_simulator_req/10_architecture/10.40_TS_state_machine.md; thought_simulator_req/10_architecture/10.50_TS_data_model.md; thought_simulator_req/20_requirements/20.60_testing_and_validation.md | §3, §8, §13, §14; §3.1, §6; §4, §7, §12 | Migrated from insights.md, verification_summary.md, failures.md, and requirements_delta.md; no content loss. |",
        "",
