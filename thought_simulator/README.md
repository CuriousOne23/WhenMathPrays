...
This folder hosts the formal requirements for the Thought Manifold Simulator.

## Structure

Requirements are organized under [10_thought_simulator_req/](10_thought_simulator_req/):

- [00_foundations/](10_thought_simulator_req/00_foundations/) - project intent, principles, and conceptual grounding
- [10_architecture/](10_thought_simulator_req/10_architecture/) - TS-centric architecture and core data model
- [20_requirements/](10_thought_simulator_req/20_requirements/) - interaction, quality, observability, validation, and traceability requirements
- [30_philosophical/](10_thought_simulator_req/30_philosophical/) - reflective/philosophical companion texts
