...
5. Path A does not infer hidden motive, deception, speech-act force, or truth. Intent here means the structured object the speaker is advancing as projection. Path A does not psycho-analyze the speaker.
...
| Intended projection as six-vector stand-in | Slides 02, 05; constructs paper |
...
- 02_meaning_groups/dimensions.md — axis notes (supporting).
