...
- idob_packet:
  ...
  semantic_core:
    ...
    action: 
    patient: 
    modifiers: ['first_person_speaker']
  selected_ops:
    - modifier_resolution
  claimed_fields:
    - truth_relation
