...
- idob_packet:
  ...
  contributions:
    ...
    - {'name': 'modifier_resolution', 'family': 'mixed_descriptive', 'priority': 60, 'fragment': {'selected_ops': ['modifier_resolution'], 'semantic_core': {'selected_ops': ['modifier_resolution'], 'query_focus': '', 'predicate': '', 'theme': '', 'relation_modifiers': '', 'complement': '', 'agent': '', 'state': '', 'location': '', 'action': '', 'patient': '', 'modifiers': ['negated_state']}, 'semantic_core_tokens': ['entity']}}
...
## IdOB Space Summary
- contributors: ['copular_state', 'agent_action', 'modifier_resolution', 'residual_identity']
- contributor_labels: ['copular_state -> Copular State', 'agent_action -> Agent Action', 'modifier_resolution -> Modifier Resolution', 'residual_identity -> Residual Identity']
- contributions: [{'name': 'copular_state', 'family': 'copular_state', 'priority': 20, 'fragment': {'truth_relation': 'declarative', 'truth_relation_family_hint': 'descriptive_state'}}, {'name': 'agent_action', 'family': 'residual_identity', 'priority': 50, 'fragment': {}}, {'name': 'modifier_resolution', 'family': 'mixed_descriptive', 'priority': 60, 'fragment': {'selected_ops': ['modifier_resolution'], 'semantic_core': {'selected_ops': ['modifier_resolution'], 'query_focus': '', 'predicate': '', 'theme': '', 'relation_modifiers': '', 'complement': '', 'agent': '', 'state': '', 'location': '', 'action': '', 'patient': '', 'modifiers': ['negated_state']}, 'semantic_core_tokens': ['entity']}}, {'name': 'residual_identity', 'family': 'residual_identity', 'priority': 90, 'fragment': {'identity_geometry': 'structural_identity', 'truth_relation': 'declarative'}}]
- activation_set: ['copular_state', 'agent_action', 'modifier_resolution', 'residual_identity']
- inactive_objects: ['interrogative_wh', 'interrogative_polar', 'locative', 'mixed_descriptive']
- residual_activated: True
- overlap_events: [{'a': 'residual_identity', 'b': 'copular_state', 'mode': 'coexist', 'fields': []}]
- meaning_delta: {}
