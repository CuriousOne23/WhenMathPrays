...
- idob_packet:
  ...
  semantic_core:
    ...
    action: 
    patient: 
    modifiers: ['passive_voice_clause']
  selected_ops:
    - modifier_resolution
  claimed_fields:
    - truth_relation
