...
- tp_ie_segment_tokens:
  - ['The', 'book', 'is', 'on', 'the', 'table', 'and', 'the', 'lamp', 'is', 'on', 'the', 'desk', '.']
...
- idob_packet:
  ...
  semantic_core:
    ...
    action: 
    patient: 
    modifiers: ['locative_adjacent', 'coordinated_clauses']
  selected_ops:
    - modifier_resolution
  claimed_fields:
    - truth_relation
