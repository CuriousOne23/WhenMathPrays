...
- idob_packet:
  ...
  semantic_core:
    ...
    action: 
    patient: 
    modifiers: ['locative_adjacent', 'fragment_ellipsis']
  selected_ops:
    - modifier_resolution
  claimed_fields:
    - truth_relation
