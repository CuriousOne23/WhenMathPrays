...
- tp_ie_segment_tokens:
  - ['If', 'the', 'book', 'is', 'on', 'the', 'table', ',', 'the', 'lamp', 'is', 'in', 'the', 'hall', '.']
...
- idob_packet:
  ...
  semantic_core:
    ...
    action: 
    patient: 
    modifiers: ['locative_adjacent', 'conditional_clauses']
  selected_ops:
    - modifier_resolution
  claimed_fields:
    - truth_relation
