...
| PA-CSE-012 / copular | Please close the door. | HOLE-09 | In work | Request-force imperative handling in CnOB/SmOB: `request_imperative_rule` + `request_imperative_clause` cue for polite request imperatives. | Disambiguation from PA-CSE-020 is complete and trace-visible; row remains In work under current governance pending final promotion pass against implemented-definition gate. |
