"""
iiinb_testbench.py
TS Path A — Bounded Intake Inspection Testbench Driver
Executes: InB → IIInB
...
def create_log_file():
    ...
    log_path = os.path.join(logs_dir, f"iiinb_run_{timestamp}.log")
...
def main():
    yaml_path = os.path.join(
        os.path.dirname(__file__),
        "../../../04_testbenches/path_a/testbenches/path_a/intake/iiinb_testbench.yaml"
    )
    ...
    print("Starting InB → IIInB testbench...\n")
