...
> **the deterministic, structured, provenance‑tracked refinement of meaning fields as they progress down Path‑A.**

Cognition is not a single primitive.  
Cognition is the **progressive resolution of meaning**.
...
Meaning resolution increases across Path‑A:

1. **InB → IIInB → IE** — raw meaning  
2. **CEx** — extracted meaning (cognition begins)  
3. **CE** — stable meaning  
4. **ISc** — evaluated meaning  
