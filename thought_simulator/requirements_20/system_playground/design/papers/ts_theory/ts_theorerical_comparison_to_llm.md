...
TS replays meaning.  
TS routes meaning.  
TS maintains identity continuity.

TS succeeds — scientifically.
...
But the nature of that offline phase is fundamentally different.
...
LLMs do not propose any underlying laws of communication.  
They simply learn statistical geometry.
...
- governed by meaning state vector  

TS does not claim to have discovered the laws of communication.  
TS claims those laws exist — and that discovering them is a valid scientific project.
...
- meaning has invariants  
- communication has laws  
- cognition has rules  
- semantics has structure  
- discourse has primitives  

LLMs succeed without explaining *why* they succeed.
...
TS treats meaning as a structured cognitive object arising from deterministic coupling of stated content and contextual structure.

LLMs avoid the question of underlying laws of communication.  
TS asserts those laws exist — and that discovering them is a valid scientific project.
