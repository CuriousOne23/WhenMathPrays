# **dictionaries_runtime — TS Runtime Dictionary (Path A)**
...
```
dictionaries_runtime/tools/ts_meaning_dct_path_a.py
```
...
### ✔ Runtime dictionary files live at the top level  
### ✔ Tools live in `tools/`  
### ✔ Tools **never** write into this directory directly  
### ✔ Users manually move generated runtime files here  
...
`dictionaries_runtime` is the **final, TS‑ready dictionary** for Path A.  
