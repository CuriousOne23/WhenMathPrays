...
The Conversation Object Basin (COB) is the long‑horizon identity substrate of Path‑A.  
It maintains:
...
COB provides the stable foundation that:

- CST measures  
- CIL integrates with short‑term cues  
- CEx extracts from for TP metadata  
...
COB does **not** interact with OB, IB, RB, TB, InB, or OuB.

Structural changes to identity layers occur only through deterministic lifecycle operations triggered by CST signals or internal capacity rules.

---

# **3. Normative Requirements (HLRs)**  
### *All HLR numbers preserved. Text rewritten for clarity where needed.*
...
**HLR‑20.32‑002**  
COB SHALL apply CST correction signals to identity‑layer structures deterministically.
...
# **11. Informative Sections (No SHALL)**
