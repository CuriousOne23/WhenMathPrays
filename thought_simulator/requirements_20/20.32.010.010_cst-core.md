...
### **HLR‑20.107.030‑045**  
CEx‑Pck SHALL ingest `TP.cil.identity_lineage` and preserve it verbatim in `TP.metadata.cil_metadata.identity_lineage`.

### **HLR‑20.107.030‑046**  
CEx‑Pck SHALL ingest `TP.cil.continuity_lineage` and preserve it verbatim in `TP.metadata.cil_metadata.continuity_lineage`.

### **HLR‑20.107.030‑047**  
CEx‑Pck SHALL ingest `TP.cil.topology` and preserve it verbatim in `TP.metadata.cil_metadata.topology`.

### **HLR‑20.107.030‑048**  
CEx‑Pck SHALL ingest all scalar fields in `TP.cil.metrics` and preserve them verbatim in `TP.metadata.cil_metadata.metrics`:
- `ambiguity_score`  
- `collapse_risk`  
- `drift_score`  
- `stability_score`  
...
### **HLR‑20.107.030‑049**  
CEx‑Pck SHALL treat all fields in `TP.cil.metrics` as read‑only and SHALL NOT compute, modify, or reinterpret any metric.

### **HLR‑20.107.030‑050**  
CEx‑Pck SHALL ingest `TP.cil.register_continuity` and preserve it verbatim in `TP.metadata.cil_metadata.register_continuity`.

### **HLR‑20.107.030‑051**  
CEx‑Pck SHALL ingest `TP.cil.importance_continuity` and preserve it verbatim in `TP.metadata.cil_metadata.importance_continuity`.

### **HLR‑20.107.030‑052**  
CEx‑Pck SHALL expose all lineage, topology, metric, and continuity fields (HLR‑20.107.030‑045 through HLR‑20.107.030‑051) to downstream primitives exactly as provided by CIL.

### **HLR‑20.107.030‑053**  
CEx‑Pck SHALL guarantee deterministic replay of all lineage, topology, metric, and continuity fields preserved from CIL.
