...
**OuBA: Output Basin A:** Freezes finalized Path‑A meaning into an immutable semantic snapshot for DF intake.  
...
**OuBA: Output Basin A:** Freezes Path‑A meaning for DF intake.  
