...
- One-command generation of visualization suites (see [18_visualization_exploration.md](18_visualization_exploration.md)).

**EXP-INT-03: Interfaces and I/O Integration**  
- Follows contracts in [17_interfaces_and_io.md](17_interfaces_and_io.md).
