...
- All visualization tools consume data exclusively via interfaces defined in [17_interfaces_and_io.md](17_interfaces_and_io.md) (snapshots, live JSON Lines streams, exports).
...
- Support live visualization via structured metric streams ([see 17](17_interfaces_and_io.md)).
