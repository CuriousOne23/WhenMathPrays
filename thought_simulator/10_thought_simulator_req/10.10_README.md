# 10.10_Thought Manifold Requirements

This directory is the formal requirements source for the Thought Manifold Simulator.

The canonical requirements path is `thought_simulator/10_thought_simulator_req/`.
...
16. [16_security_and_safety_requirements.md](20_requirements/16_security_and_safety_requirements.md)
...
21. [10.30_tp_requirements.md](20_requirements/10.30_tp_requirements.md)
22. [21_risks_assumptions.md](20_requirements/21_risks_assumptions.md)
23. [22_program_flow.md](20_requirements/22_program_flow.md)
24. [23_glossary.md](20_requirements/23_glossary.md)
25. [24_traceability_matrix.md](20_requirements/24_traceability_matrix.md)
...
Use [24_traceability_matrix.md](20_requirements/24_traceability_matrix.md) for cross-document linkage between conceptual, architectural, and implementation-facing requirements, including TP-specific requirements in [10.30_tp_requirements.md](20_requirements/10.30_tp_requirements.md).
