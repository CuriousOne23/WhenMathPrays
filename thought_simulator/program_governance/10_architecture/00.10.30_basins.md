...
Basins (Object Basins, Routing Basins, and variants such as Inquiry Basins or Feeling OBs) are core structural elements within the fixed-time-step, deterministic entropy-reduction engine. They are **not** geometric objects — they are stateful processing regions that manage tagging, coherence, transformation, and entropy reduction of one or more ThoughtPoints simultaneously.
...
- **Inquiry Basins (IB)**, **Governing Basins (GB)**, **Truth Basins (TB)**, **Input Basins (InB)**, **Output Basins (OuB)**, **Monitoring Basins (MB)**, **Feeling / Evaluation Basins**, and **Done / Terminal Basins** must follow all common rules above.
