...
- Entropy is updated primarily inside Object Basins (strong reduction) and secondarily inside Routing Basins (minor or preservation).
...
- Regulators (anti-collapse, Flow Modulators, Watchdog class behaviors, etc.) evaluate system state after main processing.
