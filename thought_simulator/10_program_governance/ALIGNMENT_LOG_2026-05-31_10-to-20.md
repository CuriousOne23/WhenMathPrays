...
1. `10_program_governance/00_foundations/00.10_vision_and_objectives.md`
...
2. `10_program_governance/00_foundations/00.20_core_philosophy_and_principles.md`
...
3. `10_program_governance/00_foundations/00.30_core_conceptual_requirements.md`
...
4. `10_program_governance/10_architecture/10.10_system_architecture.md`
- Expanded TS Core layer description to explicitly include control components terminology:
  - `Flow Modulators`
  - `Watchdog behaviors`

5. `10_program_governance/10_architecture/10.20_manifold_specification.md`
- Renamed manifold geometry subheading:
  - `Relational Basin (RB) Geometry` -> `Routing Basin (RB) Geometry`

6. `10_program_governance/10_architecture/10.30_basins.md`
...
7. `10_program_governance/10_architecture/10.40_TS_state_machine.md`
...
## Validation Notes
- Search across `10_program_governance/**/*.md` shows no remaining active use of `Relational Basin(s)` except in explicit historical-note alias lines.
