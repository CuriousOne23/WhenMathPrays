...
- `00_foundations/` - vision, principles, and conceptual grounding
- `10_architecture/` - architecture framing and system model references
- `30_philosophical/` - companion philosophical texts
