...
* The TS is a **research instrument** first â€” scientific reproducibility, conceptual fidelity, and debuggability take precedence.
...
- Core engine target: â‰¥ 10,000 ticks/second (single thread) with 1,000 active TPs under standard observability (detailed targets in [20.40_performance_requirements.md](20.40_performance_requirements.md)).
...
* All non-functional targets are achieved while satisfying the stricter requirements in documents 11â€“14 and 16+.
