...
- **XP / exec_plan / exec_trace:**
  - XP: Execution Plan; regenerable B‑side execution artifact derived from the committed semantic snapshot, providing deterministic, audit‑ready realization instructions without carrying meaning or influencing Path‑A.  
