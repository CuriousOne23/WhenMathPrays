...
- **LI (Local Inference Primitive) + MLI‑prc:**  
  ...
  LI:
  - reads representation‑layer fields, `ssr.truth_tags`, `tp.safety_flags`, and `tp.continuity_fields`,  
  - invokes `MLI‑prc`,  
  - writes **meaning‑layer fields**: `tp.meaning`, `ssr.mli_status`, `tp.mli_confidence`, `ssr.mli_conflict`, `ssr.mli_reason_code`, `ssr.mli_revision_cycles`.
