...
At each turn *t*, CST‑Core extracts a structural snapshot for each identity layer *L*. Snapshots include referent maps, temporal anchors, discourse anchors, lineage connections, register state, and field‑importance weights.
...
CST‑Core counts how often structural features appear across the last 10 turns and computes normalized frequencies and ordered histories.
...
Freeze halts structural updates to prevent further degradation when instability becomes unsafe.
...
CST‑Core SHALL trigger freeze when combined instability exceeds the layer‑specific freeze threshold.

**HLR‑20.32.010.010‑024**  
CST‑Core SHALL halt snapshot updates for frozen layers.

**HLR‑20.32.010.010‑025**  
CST‑Core SHALL halt stability‑metric updates for frozen layers.

**HLR‑20.32.010.010‑026**  
CST‑Core SHALL halt threshold adaptation for frozen layers.
...
Thaw restores normal structural evolution once stability returns. Thaw is condition‑based, not time‑based.

## **8.2 Thaw Requirements (Normative)**  
**HLR‑20.32.010.010‑027**  
CST‑Core SHALL trigger thaw when combined instability falls below the layer‑specific recovery threshold.

**HLR‑20.32.010.010‑028**  
CST‑Core SHALL resume snapshot updates upon thaw.

**HLR‑20.32.010.010‑029**  
CST‑Core SHALL resume stability‑metric updates upon thaw.

**HLR‑20.32.010.010‑030**  
CST‑Core SHALL resume threshold adaptation upon thaw.
...
Continuity restoration repairs structural stability after freeze or collapse, enabling safe resumption of normal evolution.
...
CST‑Core SHALL restore continuity when integrated continuity exceeds the layer‑specific continuity‑recovery threshold.

**HLR‑20.32.010.010‑034**  
CST‑Core SHALL apply queued structural corrections deterministically during continuity restoration.
...
CST‑Core is fully deterministic: no randomness, no external state, no wall‑clock time, and replay‑safe behavior.
...
---
- A merge‑ready PR description for GitHub  
