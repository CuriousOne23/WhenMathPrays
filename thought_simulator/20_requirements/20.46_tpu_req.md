# **20.46 — TPU Requirements (v0.5, Architecture‑Aligned)**  
with:

- all **TB** references removed from the input pipeline  
- all **RB/OB** references removed from the input pipeline  
- the **correct inference path** inserted  
- the **correct Merge → TPU → TP** semantics preserved  
- **ISc** clarified as the input‑side scorer  
- **CEx/CE** added where appropriate  
- **no Path‑B semantics** included  
- **no IB/TB/GBIB/GB** in the input pipeline  
- **no semantic repair** in TPU  
- **writer authority** preserved  
- **safe boundaries** preserved  
- **1‑TP‑cycle lag** preserved  

Everything else in 20.46 was already correct.

---

# ✅ **20.46_tpu_requirements.md (Updated v0.5 — Architecture‑Aligned)**
