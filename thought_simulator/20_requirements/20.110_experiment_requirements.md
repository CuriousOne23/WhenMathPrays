...
contains:
  - HLR: [HLR-20.110-001]
---
# 20.110_Experiment Management Requirements
...
* Experiment management tools operate as **observer / orchestration layers** â€” they never modify the core TS engine during a run.
* Experiments must support single runs, parameter studies, and batch executions.
* Full end-to-end traceability from definition â†’ execution â†’ results â†’ analysis.

## 3. Experiment Definition and Structure

**EXP-DEF-01: Experiment Specification**  
- Defined in a single, validated YAML file stored in the experiment directory.
- Mandatory fields:
...
- Same experiment definition â†’ bitwise-identical results (logs, snapshots, outputs).
...
- One-command generation of visualization suites (see [20.100_visualization_exploration.md](20.100_visualization_exploration.md)).

**EXP-INT-03: Interfaces and I/O Integration**  
- Follows contracts in [20.90_interfaces_and_io.md](20.90_interfaces_and_io.md).
...
**Version**: 0.3  
**Changes from 0.2**:
- Incorporated Copilotâ€™s four recommended refinements (Failure Handling, Experiment Templates, Statistical Comparison Tools, Invariant Tests).
