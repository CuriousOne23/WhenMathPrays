...
|------|------------|-------|-------|
| Stage 2 normative B drafts | Stage 1a + OQ-001 | 2026-06-06 | Stage 1 **in progress**; `mtp_snapshot_id` vs `commit_id` open |
...
**Approved 2026-06-06.** Current GATE: **Stage 1a** naming (§5, OQ-001).
