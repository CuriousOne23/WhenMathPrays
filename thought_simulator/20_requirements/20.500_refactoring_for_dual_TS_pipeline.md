...
|----|----------|--------|--------|
| 20.12 | TS invariants | Annex/gloss or explicit no-touch — **GATE decision** | `discussion` |
...
| CIL | Conversation Input Layer | | Conversation | `deferred` | | Stage 1b | 20.33 — separate from CI |
