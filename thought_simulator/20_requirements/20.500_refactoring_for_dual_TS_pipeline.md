...
**Version:** 0.2  
**Date:** 2026-06-06  
**Status:** Active — Phase 0 complete; Stage 1a complete; **Stage 2 stack fully approved** (2026-06-07); Stage 3 placeholders complete (**Copilot signed 2026-06-07**; CuriousOne23 sign-off pending); **GATE: post–Stage 2** (Track C / §8 / Stage 4 existing docs / Stage 5)
...
| [20.36](20.36_canonical_end_to_end_trace.md) | Assertion checklist in 20.500 §10; minimal inline TODOs | `draft` | 2026-06-07 | §2.2.1 TODOs + Class 1 comment; Copilot ☑ 2026-06-07; normative HLRs Stage 4 |
...
| 20.36 | Canonical trace / replay | 3→4 | P2 | `draft` | v0.4+ | | 20.205, 20.206 |
...
| 20.36 | 0.3→ | 3→4 | `draft` | 2026-06-07 | | | — |
...
| **C — 20.36** | Normative D17/D2/`b_regeneration_equivalent` updates | Stage 4 |
...
- **D17** — TrigRB vs SRP stage order: **resolved in 20.206 v0.2** (`trig_rb → srp_lookup`); 20.36 §2.2 normative update pending Stage 4
- **D8** — `commit_id` hash wire format: **resolved in 20.120 v0.2** (SHA-256 preimage); 20.95 canonical serialization confirm pending
- **D2** — `semantic_snapshot_ref` hash vs embedded copy (20.206, 20.207, 20.39)
...
**Approved 2026-06-06.** Current GATE: **post–Stage 2 + 20.120** — 20.110 harden, 20.36 normative pass, §8 re-review, Stage 5 grep (§7.5). §6 / Stage 3 sign-off optional in parallel.
