...
| 20.120 | MTP schema | Add `commit_id` wire field; align HLR-20.120-006 snapshot IDs with 20.115 D8/D11 — **Stage 4 with 20.115** | `not_started` |
...
| 20.120 schema update | 20.115 Stage 4 approval | 2026-06-06 | Thin v0.1; needs `commit_id` + 20.115 D8/D11 |
...
- Stage 2 rough drafts: 20.206, 20.205, 20.115, 20.207, 20.55–20.57, 20.41–20.43, 20.58 (all `draft`, none approved)
...
| Step | Document | Notes |
|------|----------|-------|
| 1 | **20.206** | A↔B sync contract — unblock 20.115 / 20.205 |
| 2 | **20.115** | MTP hardening + `commit_id` |
| 3 | **20.205** | XP wrapper model |
...
| **C — Schema** | After 20.115 approval: harden **20.120** with `commit_id` | Stage 4 |
