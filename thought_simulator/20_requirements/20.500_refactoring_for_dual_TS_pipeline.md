...
**How to use this document:** Treat §2–§3 as the execution contract. Update status columns in §7 as work progresses. **Resume here → §7.5.** Phase 0 signed; Stage 1a complete; Stage 2 drafts complete 2026-06-06; **Stage 3 placeholders complete 2026-06-07** (20.10, 20.30, 20.36). **Current GATE:** Stage 2 stack **fully approved** (2026-06-07). Next: Stage 3 sign-off / §8 re-review / **Track C 20.120** / Stage 5 grep close-out. Optional: **§6 CI manifest** (1.5b).
...
| 20.120 | MTP schema | Add `commit_id` wire field; align HLR-20.120-006 snapshot IDs with 20.115 D8/D11 — **unblocked** (20.115 approved) | `not_started` |
...
| 20.120 schema hardening | Ready — Track C | 2026-06-07 | 20.115 approved; thin v0.1 needs `commit_id` + D8/D11 alignment |
...
| **B — 20.120** | Schema hardening with `commit_id` (Track C) | Stage 4 |
...
- **D8** — `commit_id` hash wire format (20.115, 20.120, 20.39)
- **D2** — `semantic_snapshot_ref` hash vs embedded copy (20.206, 20.207, 20.39)

**Still thin / deferred:** 20.120 (pre-`commit_id` schema); Stage 1.5b mechanical renames; CP-approved A modules (§8 re-review queue).
...
**Approved 2026-06-06.** Current GATE: **post–Stage 2** — Track C (20.120), §8 re-review, Stage 4 on existing docs (20.10/20.30/20.36/20.110), Stage 5 grep (§7.5). §6 / Stage 3 sign-off optional in parallel.
