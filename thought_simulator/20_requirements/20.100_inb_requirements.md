...
- **Semantic input error correction** — inferring user intent, choosing between plausible meanings, or applying user-specific shorthand meaning. That capability is **out of scope for InB** and is specified in the input-correction follow-on program (IIInB / UPI / USP — see [20.500](20.500_refactoring_for_dual_TS_pipeline.md) §7.7).
