...
### **HLR‑20.44-015 — CE‑Bound Context Only**  
...
### **HLR‑20.44-016 — Structured Output Object**  
ISc SHALL output the full `isc_output{}` structure.

### **HLR‑20.44-017 — Canonical Serialization**  
ISc outputs SHALL follow canonical serialization rules.

### **HLR‑20.44-018 — 1‑TP‑Cycle Lag**  
...
### **HLR‑20.44-019 — Merge‑Only Commit Path**  
ISc SHALL commit only via Merge → TPU → TP.

### **HLR‑20.44-020 — Writer Authority Compliance**  
ISc SHALL write only to the `isc{}` block.

### **HLR‑20.44-021 — No Direct TPU / TP Writes**  
...
### **HLR‑20.44-044 — Deterministic Fallback Behavior**  
### **HLR‑20.44-045 — Replay‑Safe Error Handling**  
### **HLR‑20.44-046 — Error Object Emission**  
### **HLR‑20.44-047 — No TS Halt on Error**  
### **HLR‑20.44-048 — Audit Logging Requirements**  

---

## **13. Canonical Ordering & Serialization**  

### **HLR‑20.44-049 — Canonical Ordering Compliance**  
### **HLR‑20.44-050 — Deterministic Hashing**  
### **HLR‑20.44-051 — Canonical Audit Serialization**  

---

## **14. Verification Requirements**  

### **HLR‑20.44-052 — Replay Tests**  
### **HLR‑20.44-053 — Canonical Ordering Tests**  
### **HLR‑20.44-054 — COP Escalation Path Tests**  
### **HLR‑20.44-055 — TCU Degradation Tests**  
### **HLR‑20.44-056 — Forbidden‑Action Tests**  
