...
### 2.2.1 Refactor coordination (20.500 Stage 3 — pending Stage 4 normative update)

> **TODO(REVIEW-20.500):** Align HLR-20.036-005 B stage order with [20.206](20.206_pipeline_a_b_synchronization_contract.md) v0.2 / [20.57](20.57_trig_rb_semantic_trigger_requirements.md): target `trig_rb → srp_lookup → exec_plan_commit → oub_expression → imr_evaluation`. **D17 resolved** at coordination layer; normative HLR edit in Stage 4.
>
> **TODO(REVIEW-20.500):** Fixture required fields — add `commit_id` as canonical commit marker; treat `mtp_snapshot_id` as deprecated alias per [20.500](20.500_refactoring_for_dual_TS_pipeline.md) §5 (HLR-20.036-007 cross-ref in Stage 4).
>
> **TODO(REVIEW-20.500):** Class 1 — add `b_regeneration_equivalent` sub-assertion per [20.207](20.207_execution_replay_specification.md) HLR-20.207-017/020 (see [20.500](20.500_refactoring_for_dual_TS_pipeline.md) §10).
>
> **TODO(REVIEW-20.500):** Negative fixture rules (Stage 4 normative HLRs) — Pipeline B stage records SHALL be **MTP-scoped** (one B segment per cycle); B envelopes SHALL NOT contain `lane_id` or `tp_id`; `exec_plan`/`exec_trace` golden fixtures SHALL validate per [20.500](20.500_refactoring_for_dual_TS_pipeline.md) §10.
...
assertions:
  ...
  - valid_exec_triple
  - seed_boundary_holds
  # TODO(REVIEW-20.500): b_regeneration_equivalent — Stage 4 per 20.207
```
