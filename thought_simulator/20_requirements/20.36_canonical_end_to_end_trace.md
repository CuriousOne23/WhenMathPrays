...
> **TODO(REVIEW-20.500):** Align HLR-20.036-005 B stage order with [20.57](20.57_trig_rb_semantic_trigger_requirements.md): target `trig_rb → srp_lookup → exec_plan_commit → oub_expression → imr_evaluation`. Resolve **D17** in Stage 4 approval pass.
>
