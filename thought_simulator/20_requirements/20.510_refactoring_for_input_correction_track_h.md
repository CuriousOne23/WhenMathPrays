...
**Version:** 0.4
**Date:** 2026-06-07  
**Status:** **Active** — Stage 2 rough drafts complete 2026-06-07 (20.101–20.103); **serial Stage 4 review** next.
...
|----|----------|-------|----------|--------|
| 20.101 | IIInB requirements | 2→4 | **P0** | `draft` |
| 20.102 | USP requirements | 2→4 | **P0** | `draft` |
| 20.103 | UPI requirements | 2→4 | **P0** | `draft` |
...
|--------|-------|--------|-----------|
| `usp_rule` | USP entry | `draft` | 20.102 §Wire Schemas |
| `usp_version_ref` | Replay pin | `draft` | 20.102, 20.101 |
| `usp_version_record` | Version audit | `draft` | 20.102 |
| `iiinb_repair_record` | Per-turn audit | `draft` | 20.101 |
| `input_repair_tag` | TP intake-bound | `draft` | 20.101, 20.105 |
| `iiinb_escalation_ref` | CIL handoff | `draft` | 20.101, 20.33 |
| `clarification_event` | CIL → UPI | `draft` | 20.33, 20.103 |
| `upi_commit_record` | UPI → USP audit | `draft` | 20.103 |
...
| 20.101 | 0.1 | 2 | `draft` | 2026-06-07 | | |
| 20.102 | 0.1 | 2 | `draft` | 2026-06-07 | | |
| 20.103 | 0.1 | 2 | `draft` | 2026-06-07 | | |
...
| Stage 4 serial review | Per-doc three-way approval | 2026-06-07 | Order: **20.102 → 20.103 → 20.101** (recommended) |
...
| Step | Action | Owner |
|------|--------|-------|
| ~~1~~ | ~~**H0 GATE**~~ | ☑ **Complete 2026-06-07** |
| ~~2~~ | ~~**Stage 1a**~~ | ☑ **HQ-001, HQ-002 complete 2026-06-07** |
| ~~3~~ | ~~**Stage 2 drafts**~~ | ☑ **20.101–20.103 v0.1 complete 2026-06-07** |
| 4 | **Stage 4 serial review** — **20.102 → 20.103 → 20.101** | CuriousOne23, Copilot, Grok per doc |
| 5 | **Stage 3** — 20.33, 20.32, 20.80, 20.105 integration (after or parallel to review) | Grok + review |
| 6 | **Stage 5** — 20.190 Phase 4, registry (matrix rows added at draft) | Same change set as final approvals |
...
- [ ] §5.2 wire artifacts remain `pending` until Stage 2 drafts
