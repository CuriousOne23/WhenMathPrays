...
- Delta: `harness.py` is the only execution entrypoint for module verification
	- Document modified: `10_thought_simulator_req/10.20_tp_requirements.md`; `20_requirements/20.60_testing_and_validation.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: Verification artifacts include serialized TP state, provenance, and history for replay/audit
	- Document modified: `10_thought_simulator_req/10.20_tp_requirements.md`; `20_requirements/20.50_observability_requirements.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
...
- Delta: Verification artifacts are written into `artifacts/` instead of the module root
	- Document modified: `10_thought_simulator_req/10.20_tp_requirements.md`; `20_requirements/20.90_interfaces_and_io.md` v0.3 (May 27, 2026)
	- Version/date of modification: updated May 27, 2026
