...
- `LLR-30.30-001`: The harness shall emit a JSON artifact containing scenario results, traceability fields, and a run summary.
...
- Requirement deltas are now promoted into the canonical basin requirement anchor in `10_thought_simulator_req/50_design/10.50.30_basin_requirements.md`.
